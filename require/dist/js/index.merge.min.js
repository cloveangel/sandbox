...
define('com/gotop',['jquery'], function( $ ) {
	...
	goTop.prototype = {
		init: function() {
			...
			if ($el.length === 0) {
				console.log('回到顶部');
				this.$el = $('<div id="' + this.id + '" style="position: fixed; right: 10px; bottom: 10px; ">↑</div>');
				$('body').append(this.$el);
			} else {
				this.$el = $el;
			}
...
define('com/carousel',['require','exports','module','jquery','com/event'],function(require, exports) {
	var $ = require('jquery');
...
define('com/exposure',['require','jquery'],function(require) {
...
define('app/index',['jquery','com/gotop', 'com/event', 'com/carousel', 'com/exposure'], function($, GoTop, Event, Carousel, Exposure) {
